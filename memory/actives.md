...
Generated by `scripts/quant_memory_evolve.py` at `2026-04-26 21:51:38`.
...
### A6. Industry ranking penalties alone do not guarantee portfolio-level diversification
...
### A7. P2 execution evidence must use the canonical broker path
...
### A8. Promotion needs target-weight source and checksum evidence
...
### A9. v7 industry balance reduces industry concentration but fails promotion
...
### A10. Alpha attribution must state artifact limitations
...
### A11. Industry concentration needs invested and NAV-weight views
...
### A12. Signal pretrade defaults must be research-safe
