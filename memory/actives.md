...
Generated by `scripts/quant_memory_evolve.py` at `2026-04-26 21:05:06`.
...
### A1. Low-invested candidates can look safer than they are
...
### A2. Research strong, execution weak is often a capacity/portfolio issue, not just a signal issue
...
### A3. Industry ranking penalties alone do not guarantee portfolio-level diversification
...
### A4. v7 industry balance reduces industry concentration but fails promotion
...
### A5. Alpha attribution must state artifact limitations
...
### A6. Industry concentration needs invested and NAV-weight views
...
### A7. Research-side annualized return can be misleading when hard-pass rate is zero
